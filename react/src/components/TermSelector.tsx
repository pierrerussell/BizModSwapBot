    ...
    return (
        <Section header="1. ACADEMIC TERM">
            <div style={{ display: 'flex', gap: '8px', padding: '0 8px 8px 8px' }}>
                <div style={{ flex: 1 }}>
                    <Select header="Acad Year" value={acadYear} onChange={(e) => onYearChange(e.target.value)}>
                ...
                <div style={{ flex: 1 }}>
                    <Select header="Semester" value={semester} onChange={(e) => onSemChange(Number(e.target.value))}>
